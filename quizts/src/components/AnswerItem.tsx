            ...
            >
                <div className={"radioDiv"}>
                    <input
                        ...
                        type="radio"
                        onClick={() =>
                            dispatch(setCorrectAnswer({id: questionId, answerIndex}))
                        }
                        name={`answer ${questionId}`}
                        checked={correct === answerIndex && true}
                    />
                    <label htmlFor={`radio-${answerIndex} ${questionId}`} className="radio-label">
                        <input
                            onChange={(e) => {
                                setActiveButton(true);
                ...
                <div>
                    <h1 className="x" onClick={deleteAnswer}>
                        x
                    </h1>
                </div>
            </div>
